 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class LinkClicked implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LinkClicked';
    ...
    {
        if ((strlen($url) > 2083)) {
            throw new \InvalidArgumentException('invalid length for $url when calling LinkClicked., must be smaller than or equal to 2083.');
        }
