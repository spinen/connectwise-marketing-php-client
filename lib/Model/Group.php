...
class Group implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['public_description']) && (strlen($this->container['public_description']) > 255)) {
            $invalid_properties[] = "invalid value for 'public_description', the character length must be smaller than or equal to 255.";
        }
    ...
    public function valid()
    {
        ...
        if (strlen($this->container['public_description']) > 255) {
            return false;
        }
        return true;
    }
    ...
    {
        if (!is_null($public_description) && (strlen($public_description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $public_description when calling Group., must be smaller than or equal to 255.');
        }
