...
/**
 * CampaignSubType Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Spinen\ConnectWise\Clients\Marketing
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CampaignSubType implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CampaignSubType';
    ...
    {
        if ((strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CampaignSubType., must be smaller than or equal to 100.');
        }
