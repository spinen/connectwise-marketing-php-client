 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CampaignType implements ArrayAccess
{
    ...
    {
        if ((strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CampaignType., must be smaller than or equal to 100.');
        }
